...
class Loading():
    ...
    def save_df_month(self, df_month:DataFrame, current_month:str, csv_path:Path):
        ...
        if not csv_path.exists():
            ...
            season_df = pd.read_csv(self.folder + '/2021_2022_season.csv')
            ...
            if not ((season_df.merge(df_month)).drop_duplicates().reset_index(drop=True).equals(df_month)): 
                ...
                season_df.to_csv(self.folder + '2021_2022_season.csv', index=False)
    ...
    def add_df_month_to_season_df(self, df_month:DataFrame, current_month:str):
        ...
        df_old = pd.read_csv(self.folder + current_month + '_data.csv') # Extract the old DataFrame

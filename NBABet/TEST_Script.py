...
merged_19 = pd.read_csv('past_data/merged_seasons/2017_to_2019_Stats.csv', sep=';')
merged_20 = pd.read_csv('past_data/merged_seasons/2017_to_2020_Stats.csv', index_col=False)
merged_21 = pd.read_csv('past_data/merged_seasons/2017_to_2021_Stats.csv', index_col=False)
